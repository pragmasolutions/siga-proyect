Public NotInheritable Class Splash
    ...
    Private Sub Splash_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'If My.Settings.idEmpresa = 1 Then
        '    Me.BackgroundImage = My.Resources.splash_antuan
        'ElseIf My.Settings.idEmpresa = 2 Then
        '    Me.BackgroundImage = My.Resources.splash_nazatra
        'End If
    ...
    '    AntuanData.ClsEnumerados.Instancia = Nothing
    '    AntuanData.ClsEnumerados.FillAll(ProcesosLabel)
    '    ' Me.txtProceso.Text = msg
    'End Sub
