Public Class FrmPedidoCategoria
    ...
    Private Sub FrmPedidoCategoria_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dgvCategorias.DataSource = ClsEnumerados.Instancia.lstPedidoCategoria
    ...
    Private Sub dgvCategorias_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgvCategorias.SelectionChanged
        If dgvCategorias.SelectedRows.Count = 1 Then
            Cls.PedidoCategoria = CType(dgvCategorias.CurrentRow.DataBoundItem, pedido_categoria)
            txtNombre.Text = Cls.PedidoCategoria.nombre
        End If
    End Sub
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        Cls.PedidoCategoria.EstadoFila = "N"
    ...
    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        Cls.PedidoCategoria.EstadoFila = "U"
        pnlNombre.Enabled = True
        btnGuardar.Enabled = True
        btnCancelar.Enabled = True
        btnCancelar.Enabled = True
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        Cls.PedidoCategoria.nombre = txtNombre.Text
        If Cls.PreservarPedidoCategoria Then
            pnlNombre.Enabled = False
            btnGuardar.Enabled = False
            btnCancelar.Enabled = False
            btnNuevo.Enabled = True
